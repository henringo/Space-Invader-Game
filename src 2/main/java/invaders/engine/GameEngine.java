...
public class GameEngine  {
	...
	private List<Renderable> pendingPoints = new ArrayList<>();
				...
				if((renderableA.getRenderableObjectName().equals("Enemy") && renderableB.getRenderableObjectName().equals("EnemyProjectile"))
					...
					if(renderableA.isColliding(renderableB) && (renderableA.getHealth()>0 && renderableB.getHealth()>0)) {
						...
						if (renderableA.getRenderableObjectName().equals("PlayerProjectile")) {
							if (!pendingPoints.contains(renderableB)&&(!renderableB.getRenderableObjectName().equals("Bunker"))) {
								pendingPoints.add(renderableB);
							}
						}
						if (renderableB.getRenderableObjectName().equals("PlayerProjectile")) {
							if (!pendingPoints.contains(renderableA)&&(!renderableA.getRenderableObjectName().equals("Bunker"))){
								pendingPoints.add(renderableA);
							}
						}
					}
				}
	...
	public List<Renderable> getPendingPoints() {
